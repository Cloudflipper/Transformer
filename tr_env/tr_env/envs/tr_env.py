...
class tr_env(MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        pos_r01_left_end_b = self.data.geom("s0").xpos.copy()
        pos_r23_left_end_b = self.data.geom("s2").xpos.copy()
        pos_r45_left_end_b = self.data.geom("s4").xpos.copy()
        left_COM_before = (pos_r01_left_end_b+pos_r23_left_end_b+pos_r45_left_end_b)/3
        pos_r01_right_end_b = self.data.geom("s1").xpos.copy()
        pos_r23_right_end_b = self.data.geom("s3").xpos.copy()
        pos_r45_right_end_b = self.data.geom("s5").xpos.copy()
        right_COM_before = (pos_r01_right_end_b+pos_r23_right_end_b+pos_r45_right_end_b)/3
        ...
        cap_vel =  np.hstack((pos_r01_left_end-pos_r01_left_end_b , \
                            pos_r01_right_end-pos_r01_right_end_b , \
                            pos_r23_left_end-pos_r23_left_end_b , \
                            pos_r23_right_end-pos_r23_right_end_b,\
                            pos_r45_left_end-pos_r45_left_end_b , \
                            pos_r45_right_end-pos_r45_right_end_b))
